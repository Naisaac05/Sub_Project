...
class AiReviewProductionConfigValidatorTest {
    ...
    private static AiReviewProperties unsafePropertiesWithMissingToken() {
        return new AiReviewProperties(
                ...
                null,
                new AiReviewProperties.PythonAi(true, "http://ai:8001", "qwen3:1.7b", 0.2, 0, 0, 4, 0, ""),
                new AiReviewProperties.Ollama(true, "qwen3:4b-q4_K_M", "http://ollama:11434", 0.2, 0, 0, 4, 0, 1),
                null,
    ...
    private static AiReviewProperties safeProdProperties() {
        return new AiReviewProperties(
                ...
                AiReviewProperties.Provider.PYTHON,
                null,
                new AiReviewProperties.PythonAi(true, "http://ai:8001", "qwen3:1.7b", 0.2, 256, 1024, 4, 30, "token"),
                new AiReviewProperties.Ollama(true, "qwen3:4b-q4_K_M", "http://ollama:11434", 0.2, 256, 1024, 4, 30, 1),
                null,
