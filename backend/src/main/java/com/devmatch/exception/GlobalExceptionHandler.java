...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AiReviewRateLimitExceededException.class)
    public ResponseEntity<ApiResponse<Void>> handleAiReviewRateLimitExceeded(
            AiReviewRateLimitExceededException e
    ) {
