...
public record AiReviewProperties(
    ...
    public AiReviewProperties {
        ...
        if (python == null) {
            python = new PythonAi(true, "http://localhost:8001", "exaone3.5:2.4b", 0.2, 256, 1024, 4, 30, "");
        }
        if (ollama == null) {
            ollama = new Ollama(true, "exaone3.5:2.4b", "http://localhost:11434", 0.2, 256, 1024, 4, 30, 1);
        }
        if (ruleBased == null) {
