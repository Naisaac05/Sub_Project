...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initDefaultFaqs() {
        ...
        List<Faq> seeds = List.of(
            Faq.builder()
                .category(FaqCategory.SERVICE_INTRO).orderIndex(0).published(true)
                ...
                .build(),
            Faq.builder()
                .category(FaqCategory.SERVICE_INTRO).orderIndex(1).published(true)
            ...
            Faq.builder()
                ...
                .build(),
            Faq.builder()
                .category(FaqCategory.MENTORING).orderIndex(0).published(true)
                ...
                .build(),
            Faq.builder()
                .category(FaqCategory.MENTORING).orderIndex(1).published(true)
