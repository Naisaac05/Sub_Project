...
> **[2026-07-27 후속] Flyway 도입으로 아래 수동 절차는 대체되었다.**
> `V2__add_unique_application_id_on_payments.sql` 로 마이그레이션화되어 앱 기동 시 자동 적용된다.
> 아래 내용은 "왜 수동이 필요했는지"의 기록으로 남긴다. 자세한 도입 경위는
> `error/2026-07-27-flyway-adoption-schema-drift.md` 참조.

**⚠️ prod 마이그레이션 필요 — 자동 반영되지 않음 (Flyway 도입 전 기준)**
